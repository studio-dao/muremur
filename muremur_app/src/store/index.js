...
export default new Vuex.Store({
  state: {
    liste_fruits: [{
      ...
      {
        label: 'Banane',
        maturite: 'Pour savoir si votre banane est mûre, il faut qu &#039 elle soit bien jaune. Si elle est verte\
      ...
      {
        label: 'Ananas',
        maturite: 'Soupesez et sentez-le : il doit être lourd et parfumé. Les feuilles de sa couronne doivent être d &#039 un vert bien franc\
    ...
    liste_legumes: [{
        label: 'Avocat',
        maturite: 'c &#039  est trop mûr. Si c &#039 est vert, vous pouvez y aller. Et si la tige ne s &#039  en va pas facilement, c &#039 est que l &#039 avocat n &#039 est pas encore mûr.',
      ...
      {
        label: 'Aubergine',
        maturite: 'Si vous appuyez doucement du bout des doigts l &#039  aubergine, trois choses différentes peuvent se passer : Si la chair ne se déforme pas\
      ...
      {
        label: 'Potiron',
        maturite: 'Si le potiron est en magasin vous pouvez être sûr qu &#039 il est mur. On reconnaît une courge mûre à sa couleur bien sûr, \
      ...
      {
        label: 'Tomate',
        maturite: 'les tomates rouges sont mûres.Pour choisir de bonnes tomates, il faut avant tout humer leur parfum. C &#039 est le premier indice qui vous mettra\
